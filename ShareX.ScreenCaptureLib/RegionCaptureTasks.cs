...
namespace ShareX.ScreenCaptureLib
{
    public static class RegionCaptureTasks
    {
        ...
        {
            //RegionCaptureOptions newOptions = GetRegionCaptureOptions(options); // RCD 4-30-24
        ...
        {
            //using (RegionCaptureTransparentForm regionCaptureTransparentForm = new RegionCaptureTransparentForm()) // RCD 4-30-24
            //{
        ...
        {
            //if (bmp != null && gp != null) // RCD 4-30-24
            //{
